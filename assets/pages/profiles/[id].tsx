...
export const DIDPage: React.FC = () => {
  ...
  const renderHeader = () =>
    isLoading ? (
      ...
      <div className="sm:mb-5">
        <div className="text-2xl font-bold">{hasName ? name : encodedId}</div>
        {hasName ? <div className="text-lg">{encodedId}</div> : <div></div>}
      </div>
    );
  const renderCreatedGallery = () =>
    isLoadingCreatedNfts ? (
      ...
      <div>
        <div className="flex justify-center text-4xl font-bold">Created NFTs</div>
  ...
  const renderOwnedGallery = () =>
    isLoadingOwnedNfts ? (
      ...
      <div>
        <div className="flex justify-center text-4xl font-bold">Owned NFTs</div>
        <div className="mb-2 flex justify-end">
          <button
...
export const TwitterSvg = () => {
  return (
    <svg className="h-10 w-10 fill-none stroke-gray-800 dark:stroke-gray-200" viewBox="0 0 20 20">
      <path
        fill="evenodd"
...
export const WebsiteSvg = () => {
  return (
    <svg className="h-10 w-10 fill-gray-800 dark:fill-gray-200" viewBox="0 0 20 20">
      <path
        fill="evenidd"
