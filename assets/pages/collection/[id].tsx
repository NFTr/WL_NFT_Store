...
export const CollectionPage: React.FC = () => {
  ...
  (isLoading ? <div>Loading...</div> : (
      <div className="-mt-10 mb-20 sm:mb-5">
          <img className="w-full h-60 flex bg-center object-cover rounded-xl brightness-105 dark:brightness-95" src={bannerUrl}/>
          <div className='sm:ml-10 flex sm:space-x-8'>
            <div className='-translate-y-24 translate-x-4 sm:-translate-y-1/3 sm:translate-x-0'>
             <img className="w-20 h-20 sm:w-32 sm:h-32 lg:w-40 lg:h-40 bg-center object-cover rounded-xl border-4 border-zinc-50 dark:border-zinc-800 shadow-lg backdrop-blur" src={iconUrl}/>
