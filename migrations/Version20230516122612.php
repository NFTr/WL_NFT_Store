 ...
 */
final class Version20230516122612 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE nft_event (id INT AUTO_INCREMENT NOT NULL, nft_id VARCHAR(255) NOT NULL, owner_id VARCHAR(255) DEFAULT NULL, address_id VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, timestamp DATETIME NOT NULL, xch_price DOUBLE PRECISION DEFAULT NULL, event_index INT NOT NULL, INDEX IDX_7C5F5404E813668D (nft_id), INDEX IDX_7C5F54047E3C61F9 (owner_id), INDEX IDX_7C5F5404F5B7AF75 (address_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
